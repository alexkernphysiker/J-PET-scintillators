...
int main(int , char **){
    ...
    for(auto L:lengths){
     ...
     Plot("3b")
    .Line(curve1,"solid silicon photosensors + absorption","3b-1")
    .Line(curve21,"2x5 matrix (1st) + absorption","3b-2")
    .Line(curve22,"2x5 matrix (3rd) + absorption","3b-3")
    .Line(curve2,"2x5 matrix (1st+3rd) + absorption","3b-4")
    .Line(curve3,"2x5 matrices(weighted+100%eff)","3b-5")
    <<"set key on";
    return 0;
}

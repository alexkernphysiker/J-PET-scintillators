...
int main(int , char **){
    ...
    for(auto L:lengths){
     ...
     Plot("3c")
    .Line(curve1,"1. solid silicon photosensors + absorption","3c-1")
    .Line(curve21,"2. 2x5 matrix (1st) + absorption","3c-2")
    .Line(curve22,"3. 2x5 matrix (3rd) + absorption","3c-3")
    .Line(curve2,"4. 2x5 matrix (1st+3rd) + absorption","3c-4")
    .Line(curve3,"5. 2x5 matrices(weighted+100%eff)","3c-5")
    <<"set key on";
    return 0;
}
